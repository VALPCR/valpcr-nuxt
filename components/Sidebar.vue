<template>
  <div :class="{'w-60': isSidebarOpen, 'w-24': !isSidebarOpen}" class="bg-[#131A2D] overflow-auto">
    ...
    <ul class="">
      ...
      <nuxt-link to="/" class="text-white">
        <li :class="{'sm:pl-0 md:pl-10 lg:pl-10 xl:pl-10': isSidebarOpen}" class="space-x-2 bottom-0 fixed">
