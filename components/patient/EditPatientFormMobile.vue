        ...
        <div id="accordionFlushExample">
          ...
          >
            ...
            >
              <div class="px-5 py-4 mt-7 mb-7">
                ...
                >
                  ...
                  >
                    <div class="relative mb-1" data-te-input-wrapper-init>
                      <input
                        ...
                        :disabled="
                          ...
                          (editable == false && $auth.user.id === user_id)
                        "
                      />
                      <label
                        for="date"
                    ...
                    <div class="relative mb-1 col-span-2 flex md:inline-block">
              ...
              <div
                class="mt-auto flex flex-shrink-0 flex-wrap items-center justify-end rounded-b-md p-4 dark:border-opacity-50 min-[0px]:rounded-none"
              >
                <button
...
export default {
  ...
  watch: {
    ...
    "$store.state.editPatientStepperFormFields"() {
      ...
      this.religion = this.patientFormMobileFields.pcr_patient.patient.religion;
      ...
      this.received_by = this.patientFormMobileFields.pcr_signature.received_by;
      ...
      this.team_leader = this.patientFormMobileFields.pcr_signature.team_leader;
      ...
      this.to_hospital = this.patientFormMobileFields.pcr_waiver.to_hospital;
      ...
      this.witness_one = this.patientFormMobileFields.pcr_waiver.witness_one;
      this.witness_one_signature =
        this.patientFormMobileFields.pcr_waiver.witness_one_signature;
      this.witness_two = this.patientFormMobileFields.pcr_waiver.witness_two;
