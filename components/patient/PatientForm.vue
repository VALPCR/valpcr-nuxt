  ...
  >
    ...
    >
      ...
      >
        ...
        <!--Modal body-->
        <div class="relative p-4 mt-5 mb-5">
          <form class="mx-5 mt-3">
            ...
            >
              ...
              >
                ...
                <div
                  class="relative mb-1 mt-2 col-span-2"
                  data-te-input-wrapper-init
                >
                  <textarea
                    v-model="remarks"
    ...
    this.$axios
      ...
      .then((response) => {
        response.data.return.map((emr) =>
          this.emrs.push({
            id: emr.id,
            name: `${emr.first_name !== null ? emr.first_name : ""} ${
              emr.middle_name !== null ? emr.middle_name : ""
