          ...
          >
                ...
                <div class="relative p-4">
                  <form>
                    ...
                    >
                      ...
                      <!-- MISSING AGE OF GESTATION FIELD -->
            ...
            <li data-te-stepper-step-ref class="w-[4.5rem] flex-auto">
              ...
              >
                <div class="relative p-4">
                  <form>
                    <h4 class="mb-3 font-bold">O2 Given Via:</h4>
                    <div
                      class="grid grid-col-5 sm:grid-cols-1 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 gap-4"
                    >
                      <div
                        class="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]"
                      >
  ...
  watch: {
    ...
    "$store.state.editPatientStepperFormFields"() {
      ...
      this.anterior_head_injury =
        this.patientStepperFormFields.pcr_body_injuries.anterior_head_injury;
      this.anterior_chest_injury =
        this.patientStepperFormFields.pcr_body_injuries.anterior_chest_injury;
      this.anterior_pelvis_injury =
        this.patientStepperFormFields.pcr_body_injuries.anterior_pelvis_injury;
      this.anterior_left_arm_injury =
        this.patientStepperFormFields.pcr_body_injuries.anterior_left_arm_injury;
      this.anterior_right_arm_injury =
        this.patientStepperFormFields.pcr_body_injuries.anterior_right_arm_injury;
      this.anterior_left_leg_injury =
        this.patientStepperFormFields.pcr_body_injuries.anterior_left_leg_injury;
      ...
      this.anterior_chest_degree =
        this.patientStepperFormFields.pcr_burn_percentage.anterior_chest_degree;
      this.anterior_pelvis_degree =
        this.patientStepperFormFields.pcr_burn_percentage.anterior_pelvis_degree;
      this.anterior_left_arm_degree =
        this.patientStepperFormFields.pcr_burn_percentage.anterior_left_arm_degree;
      this.anterior_right_arm_degree =
        this.patientStepperFormFields.pcr_burn_percentage.anterior_right_arm_degree;
      this.anterior_left_leg_degree =
        this.patientStepperFormFields.pcr_burn_percentage.anterior_left_leg_degree;
      this.anterior_right_leg_degree =
        this.patientStepperFormFields.pcr_burn_percentage.anterior_right_leg_degree;
      this.anterior_genitalia_degree =
        this.patientStepperFormFields.pcr_burn_percentage.anterior_genitalia_degree;
      this.posterior_head_degree =
        this.patientStepperFormFields.pcr_burn_percentage.posterior_head_degree;
      this.posterior_chest_degree =
        this.patientStepperFormFields.pcr_burn_percentage.posterior_chest_degree;
      this.posterior_pelvis_degree =
        this.patientStepperFormFields.pcr_burn_percentage.posterior_pelvis_degree;
      this.posterior_left_arm_degree =
        this.patientStepperFormFields.pcr_burn_percentage.posterior_left_arm_degree;
      this.posterior_right_arm_degree =
        this.patientStepperFormFields.pcr_burn_percentage.posterior_right_arm_degree;
      this.posterior_left_leg_degree =
        this.patientStepperFormFields.pcr_burn_percentage.posterior_left_leg_degree;
      this.posterior_right_leg_degree =
        this.patientStepperFormFields.pcr_burn_percentage.posterior_right_leg_degree;
    },
  },
  methods: {
    enableEdit() {
