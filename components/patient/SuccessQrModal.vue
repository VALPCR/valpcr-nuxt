    ...
    >
      ...
      >
        ...
        <div class="relative p-10">
          <p class="text-cyan-950 text-lg font-bold text-center">
            You have successfully submitted the PCR Form!
          </p>
          <h6
...
export default {
  ...
  watch: {
    "$store.state.newlyCreatedPcr"() {
      this.patientFormFields = this.$store.getters["getNewlyCreatedPcr"];
      this.qr_code = this.patientFormFields.qr_code;
      this.first_name = this.patientFormFields.pcr_patient.patient.first_name;
      this.middle_name = this.patientFormFields.pcr_patient.patient.middle_name;
