<template>
  <section class="bg-split">
    ...
    >
      ...
      <div
        class="p-8 max-w-md w-full bg-white rounded-lg drop-shadow-xl md:w-[70%] md:mt-10 md:border-1"
      >
        ...
        />
        <div v-if="loginError" class="text-red-700 text-sm text-center">
          {{ loginError }}
        </div>
...
<script>
import { Validation, Input, Ripple, initTE } from "tw-elements";
