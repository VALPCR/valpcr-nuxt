    ...
    >
      <div class="p-8 max-w-md w-full bg-white rounded-lg shadow-lg">
        ...
        >
          ...
          <p
            class="text-2xl text-left text-slate-900 font-bold flex items-center justify-center"
          >
            Please Check Your Email
          </p>
          <p
            class="ml-1 mr-1 text-left text-gray-500 flex items-center justify-center"
          >
