<template>
  <section class="bg-gray-50 dual-bg">
    <div class="bg2"></div>
    <div class="bg1 flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <img
        ...
        <div class="p-8 max-w-md w-full bg-white rounded-lg shadow-lg">
          <h1 class="text-3xl mb-2 text-center text-black font-bold">Forgot Password?</h1>
